...
// @ts-nocheck
  ...
  function setHeaderText(index) {
    switch(index) {
      ...
      case 1:
        return 'Increases the maximum difficulty for jobs; higher difficulty jobs reward significantly more glory.(Warning: rushing this upgrade will cause jobs to appear that may be impossible or very difficult to complete.)'
      case 2:
